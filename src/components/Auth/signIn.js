        ...
        <div className="flex-1 flex flex-col w-full px-8 sm:max-w-md justify-center gap-2">
            ...
            >
                ...
                <input
                    ...
                    placeholder="••••••••"
                />
                <button className="bg-cyan-600 rounded px-4 py-2 text-white mb-1">
                    Sign In
                </button>

                <div className="flex flex-row space-x-6">
                    <button type="button"
                            className="basis-1/2 bg-indigo-600 rounded px-4 py-2 text-white mb-6 grid grid-flow-col auto-cols-max gap-2 place-content-center"
                    ...
                    <button type="button"
                            className="basis-1/2 bg-white rounded px-4 py-2 mb-6 grid grid-flow-col auto-cols-max gap-2 place-content-center"
                            onClick={signInWithTwitch}>
                        <img className="w-6 h-6" src="https://www.svgrepo.com/show/448251/twitch.svg" loading="lazy"
                             alt="twitch logo"/>
                        <p className="font-normal text-black">Twitch</p>
                    </button>
                </div>
                ...
                <button
                    className="hover:bg-emerald-950 rounded basis-auto px-4 py-2 border-4 border-emerald-500"
