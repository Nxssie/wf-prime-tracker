...
const SignIn = () => {
    ...
    return (
            <div className="flex-1 flex flex-col w-full px-8 items-center gap-2">
                <form
                    className="flex-1 flex flex-col w-full max-w-md gap-2 text-foreground"
                    onSubmit={signIn}
                >
                    ...
                    <div className="flex flex-col pt-6 items-center">
                        <h3 className="font-bold font-normal text-xl"> Sign in with socials</h3>
                    </div>

                    <div className="flex flex-col py-4 w-full items-center">
                        <button type="button"
                                className="basis-1/2 bg-indigo-600 rounded-2xl px-4 py-2 text-white mb-6 grid grid-flow-col auto-cols-max gap-2 place-content-center max-w-md w-56 min-w-min"
                                onClick={signInWithDiscord}>
                            <Image className="w-6 h-6" src="https://www.svgrepo.com/show/452188/discord.svg"
                                 width={1}
                                 height={1}
                                 loading="lazy"
                                 alt="discord logo"/>
                        ...
                        <button type="button"
                                className="basis-1/2 bg-[#6441A4] rounded-2xl px-4 py-2 text-white mb-6 grid grid-flow-col auto-cols-max gap-2 place-content-center max-w-md w-56"
                            ...
                            <Image className="w-6 h-6"
                                 ...
                                 loading="lazy"
                                 alt="twitch logo"/>
                            <p className="font-normal">Twitch</p>
                        </button>
                        {/*<button type="button"
                                className="basis-1/2 bg-white rounded-2xl px-4 py-2 text-black mb-6 grid grid-flow-col auto-cols-max gap-2 place-content-center"
                                onClick={signInWithGoogle}>
                            <Image className="w-6 h-6" src="https://www.svgrepo.com/show/475656/google-color.svg"
                                 width={1}
                                 height={1}
                                 loading="lazy"
                                 alt="google logo"/>
